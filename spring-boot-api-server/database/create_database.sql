...
-- Inserting data into the user_profile table
...
INSERT INTO user_collection (collection_id, profile_id, comic_book_id)
VALUES
    (1, 1, 1)
    , (2, 1, 2)
    , (3, 2, 1)
...
INSERT INTO user_wishlist (wishlist_id, profile_id, comic_book_id)
VALUES
    (1, 1, 5)
    , (2, 2, 2)
    , (3, 3, 3)
...
INSERT INTO user_trade_collection (trade_collection_id, profile_id, comic_book_id)
VALUES
    (1, 1, 1)
    , (2, 2, 2)
    , (3, 3, 3)
...
CREATE TABLE trade_request (
    ...
    , profile_a_received BOOLEAN NOT NULL DEFAULT FALSE
    , profile_b_received BOOLEAN NOT NULL DEFAULT FALSE
    , PRIMARY KEY (request_id)
    , FOREIGN KEY (profile_a_id) REFERENCES user_profile(profile_id)
    , FOREIGN KEY (profile_b_id) REFERENCES user_profile(profile_id)
...
INSERT INTO trade_request (request_id, profile_a_id, profile_b_id, comic_a_book_id, comic_b_book_id, status, profile_a_received, profile_b_received)
VALUES
